...
exports.run = async function() {
    ...
    try {
        data = await bbref.rangeBatterLogs(startDateFormatted, endDateFormatted);
        ...
        // Output
        saveToFile.displayOrSave(data, `daily_batter_bref-${startDateFormatted}-${endDateFormatted}.json`);
    } catch(err) {
        console.log(`No data found for ${startDateFormatted} - ${endDateFormatted}`);
        console.log(err);
    }
