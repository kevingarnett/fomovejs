...
exports.run = async function() {
    ...
    // Fetch Pitcher Game Logs from Fangraphs
    try {
        data = await fangraphs.pitcherGameLogs(selectedPlayer.value.fangraphs_id, targetedSeason.value);
        ...
        // Output
        saveToFile.displayOrSave(data, `${selectedPlayer.value.first_name}_${selectedPlayer.value.last_name}-${targetedSeason.value}-fangraphs_pitcher_logs.json`);
    } catch(err) {
